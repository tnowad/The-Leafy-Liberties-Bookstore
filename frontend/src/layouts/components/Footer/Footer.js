...
function Footer() {
  return (
    <footer className="flex justify-center w-full flex-col items-center border-0 border-solid border-t-[1px] border-gray-400 mt-4 pt-5">
      <div className="container sm:grid sm:m-auto lg:flex">
        <div className="left-container border-0 border-solid border-gray-400 pr-3 sm:border-r-0 sm:border-b-[1px] lg:border-r-[1px] lg:border-b-0 mobile:p-0">
          <div className="sm:justify-center sm:items-center lg:flex lg:justify-start">
            ...
            <div className="flex flex-col justify-center lg:flex mobile:hidden">
              <p className="text-3xl border-0 border-solid border-b-[1px] border-gray-400 pb-1">
                Leaf Liberty
              </p>
      ...
      <div className="w-full border-0 border-solid border-t-[1px] border-gray-400 text-center pt-4 mt-6 text-gray-500">
        <p>
