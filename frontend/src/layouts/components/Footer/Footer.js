  ...
  return (
    <footer className="flex justify-center w-full flex-col items-center">
      <div className="container flex">
        <div className="left-container w-3/12 border-0 border-solid border-r-2 border-gray-400 pr-3">
          <div className="flex">
            <div className="w-28">
              <img src={bigLogo} alt="" />
            </div>
        ...
        <div className="right-container w-3/4 flex justify-between items-start px-10">
          ...
          <div className="our-services">
            <h1 className="text-xl font-medium mb-2">Our services</h1>
            <MenuLinks
              className="text-gray-600"
              items={[
          ...
          <div className="categories">
            <h1 className="text-xl font-medium mb-2">Categories</h1>
            <MenuLinks
              className="text-gray-600"
              items={[
                { name: 'Action', link: '\\' },
          ...
          <div className="contact">
            <h1 className="text-xl font-medium mb-2">Get Contact</h1>
            <MenuLinks
              className="text-gray-600"
              items={[
