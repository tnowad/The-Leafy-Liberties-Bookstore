...
export default function Product({
  ...
  return (
    <div className="product-info w-full flex flex-col justify-center items-center p-1">
      ...
      <div
        className={`product-body w-full p-1 text-lg font-medium flex flex-col justify-center items-center`}
      >
        <div className={`product-name`}>
          <a href={'/products/' + (id || 0)}>{name || 'My Dearest Darkest'}</a>
        </div>
        <div className="product-rate">
          <FontAwesomeIcon icon={faStar} size="sm" color="#ffff33"/>
          <FontAwesomeIcon icon={faStar} size="sm" color="#ffff33"/>
          <FontAwesomeIcon icon={faStar} size="sm" color="#ffff33"/>
          <FontAwesomeIcon icon={faStar} size="sm" color="#ffff33"/>
          <FontAwesomeIcon icon={faStar} size="sm" color="#000"/>
        </div>
